...
///
/// Renders the outer page frame (nav, sidebar placeholder, etc.) with a single placeholder `<div>`
/// whose content is fetched via AJAX. All per-page shell pages use this template, parameterised by
